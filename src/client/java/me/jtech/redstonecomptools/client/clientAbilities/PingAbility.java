...
public class PingAbility extends BaseAbility {
    ...
    public void toggled(boolean state) { //TODO comment this
        ...
        BlockOverlayRenderer blockOverlayRenderer = new BlockOverlayRenderer(RaycastingHelper.performRaycast(client), Color.getColor(Config.ping_color), new Vec3i(1, 1, 1), false, false, Redstonecomptools.getInstance().DEFAULT_CONTEXT, "");
