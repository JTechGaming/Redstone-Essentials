...
public class RealtimeByteOutputRenderer {
    ...
    public static List<RealtimeByteOutput> realtimeByteOutputList = new ArrayList<>();
    ...
    public void setup() {
        HudRenderCallback.EVENT.register((context, tickDeltaManager) -> {
            if (shouldRender && Config.rtbo_enabled) {
                ...
                for (RealtimeByteOutput realtimeByteOutput : realtimeByteOutputList) {
    ...
    private int getData(RealtimeByteOutput realtimeByteOutput) {
