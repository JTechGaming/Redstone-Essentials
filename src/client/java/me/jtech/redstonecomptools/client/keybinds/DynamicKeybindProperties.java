...
public class DynamicKeybindProperties {
    String command; // the command to execute when the keybind is used
    ...
    boolean hasToggleState; // the toggleState setting
    String tState1; // toggle state 1
    String tState2; // toggle state 2
    ...
    */
    boolean hasToggleInterval; // the toggleInterval setting
    long interval; // interval time in game ticks
